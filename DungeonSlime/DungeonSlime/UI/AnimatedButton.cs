...
internal class AnimatedButton : Button
{
    ...
    public AnimatedButton(TextureAtlas atlas)
    {
        ...
        NineSliceRuntime runtimeBackground = buttonVisual.Background;
        ...
        enabledState.Apply = () =>
        {
            ...
            runtimeBackground.CurrentChainName = unfocusedAnimation.Name;
        };
        ...
        focusedState.Apply = () =>
        {
            ...
            runtimeBackground.CurrentChainName = focusedAnimation.Name;
