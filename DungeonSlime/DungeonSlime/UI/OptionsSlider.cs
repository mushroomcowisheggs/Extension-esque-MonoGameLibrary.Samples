...
public class OptionsSlider : Slider
{
    ...
    public OptionsSlider(TextureAtlas atlas)
    {
        ...
        background.TextureHeight = regionBackground.Height;
        background.TextureLeft = regionBackground.SourceRectangle.Left;
        background.TextureTop = regionBackground.SourceRectangle.Top;
        background.TextureWidth = regionBackground.Width;
