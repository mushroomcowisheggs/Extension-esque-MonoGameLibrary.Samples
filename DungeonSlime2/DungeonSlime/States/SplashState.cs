...
public class SplashState : State {
    ...
    private HashSet<KeyCode> _setKeysToWaitForReleaseHash = new HashSet<KeyCode>();
    private bool _flagContentLoaded = false;
    private const float FADE_DURATION = 0.5f;
    private const float FADE_ALPHA = 1.0f;
    private const float DISPLAY_TIME = 5.0f;
    
    private static readonly KeyCode[] TriggerKeys = new[] { KeyCode.Enter, KeyCode.Space, KeyCode.Escape };
    ...
    public override void HandleInput(FrameTime timeFrame, IInputService serviceInput) {
        ...
        var keysTrigger = new[] { KeyCode.Enter, KeyCode.Space, KeyCode.Escape };
