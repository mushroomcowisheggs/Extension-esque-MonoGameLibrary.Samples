...
using MonoGameLibrary.Extensions.Primitives;
using MonoGameLibrary.Extensions.UserInterface;

namespace DungeonSlime.Scenes;

public class SlowlyGameScene : Scene {
    ...
    private void InitializeUI() {
        ...
        _ui = new GameSceneUI(_serviceAudio, ContentService, _serviceUserInterface, _atlas);
    ...
    private void InitializeNewGame() {
        ...
        _slime.Initialize(positionSlime, strideOriginal);
