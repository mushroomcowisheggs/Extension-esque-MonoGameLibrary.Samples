...
public class GameSceneUI : ContainerRuntime {
    ...
    public GameSceneUI(IAudioService serviceAudio, IContentService serviceContent, IUserInterfaceService serviceUserInterface, TextureAtlas atlas) {
        ...
        _serviceUserInterface.AddToRoot(this);
