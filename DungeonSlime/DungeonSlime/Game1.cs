...
public class Game1 : Game {
    ...
    protected override void Initialize() {
        ...
        serviceScene.ChangeScene(
            delegate(IContentService serviceContent) {
                return new TitleScene(
                    ...
                    _boundsScreen, 
                    controllerGame, 
                    loggerFile != null ? new Optional<ILogger>(loggerFile) : default(Optional<ILogger>), 
                    profiler
                );
            }
        );
    ...
    protected override void LoadContent() {
        ...
        var serviceAudio = _host.Services.Get<IAudioService>();
        serviceAudio.PlaySong(_songTheme, flagRepeat: true);
    }
